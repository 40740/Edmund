...
enum FormatMenu {
    ...
    static func viewModeToggleItem() -> NSMenuItem {
        MenuCommand(id: "view.toggleMode", group: "View", title: "切换视图模式",
    ...
    private static let listCommands: [MenuCommand] = [
        ...
        MenuCommand(id: "format.checklist", title: "待办清单",
    ...
    private static let thematicBreakCommand = MenuCommand(id: "format.thematicBreak", title: "分割线",
    ...
    private static let blockCommands: [MenuCommand] = [
        ...
        MenuCommand(id: "format.mathBlock", title: "数学块",
    ...
    private static let fontCommands: [MenuCommand] = [
        ...
        MenuCommand(id: "format.math", submenu: "字体", title: "数学",
                    action: #selector(EditorTextView.formatInlineMath(_:))),
        MenuCommand(id: "format.keyboard", submenu: "字体", title: "键盘",
    ...
    private static func calloutSubmenuItem() -> NSMenuItem {
        let item = NSMenuItem(title: "提示 / 引用", action: nil, keyEquivalent: "")
        let menu = NSMenu(title: "提示 / 引用")
        for type in githubCalloutTypes {
            menu.addItem(MenuCommand(id: "format.callout.\(type)", submenu: "提示 / 引用",
